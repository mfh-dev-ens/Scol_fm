...
public class MatiereController {
	...
	/*
	 * @PostMapping("/add") public Etudiant add(@RequestBody Etudiant etudiant ) {
	 * 
	 * return etudiantRepository.save(etudiant); }
	 */
	/*
	 * @GetMapping("/byClass") public List<Matiere> getByClass(@Param("classeId")
	 * Long classeId) {
	 * 
	 * 
	 * }
	...
	/*
	 * @GetMapping("/all") public List<Etudiant> getAll() { return
